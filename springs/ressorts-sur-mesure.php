...
<title>Springs made to order</title>
<meta http-equiv="imagetoolbar" content="no" /> 
<meta http-equiv="MSThemeCompatible" content="no" /> 
<meta name="MSSmartTagsPreventParsing" content="TRUE" />
<meta name="description" content="Springs made to order" />
...
<div id="rvf">
	<div id="top">
		...
		<div><img src="../fabrication/sur-mesure.jpg" width="538" height="133" border="0" alt="Springs for cars" /></div>
	</div>
	<div id="top2"> </div>
	<ul id="nav">
		...
		<li id="ressort-sur-mesure-en"><div><strong>Made-to-order springs <br />for specific uses<br /></strong><br /></div></li>
	</ul>
	<ul id="snav">
		<li id="snav1"></li>
		<li id="snav2"></li>
...
<h1>Springs made to order</h1>
<p>
Each spring is built based on specifications drawn up through collaboration between our customers and project leaders. 
</p>
<p>
The design and development of the springs are carried out by our engineering and design department.  
</p>
<p>
Prototypes are made at RVF to simulate the “mass production” product.  
</p>
<p>
Conditioning is defined in such as way as to optimize the distribution of our springs across our customers’ assembly line. 
</p>
<p>
We also have an assembly department so we can deliver semi-finished products with outer plastic casing, for example, to our customers. 
</p>
<p>
Endurance tests and other types of tests are conducted in our laboratory. 
</p>
<p>
We are constantly staying abreast of new technologies so we can over innovative products and bring 30 years of spring experience to our customers.
</p>
